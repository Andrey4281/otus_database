...
CREATE TABLE `product` (
    ...
    `unit_fk` integer UNIQUE NOT NULL COMMENT 'Product unit'
    );
...
CREATE TABLE `purchase_item` (
    ...
    `total_cost` decimal(10,2) NOT NULL COMMENT 'Total cost for current price and count',
...
CREATE TABLE `product_item` (
                                ...
                                `price` decimal(10,2) NOT NULL COMMENT 'Price in minor unit',
...
CREATE TABLE `credit_card` (
    ...
    `balance` decimal(10,2) NOT NULL COMMENT 'Balance in minor unit',
    `customer_fk` integer NOT NULL,
    `main` boolean NOT NULL DEFAULT false,
    `active` boolean NOT NULL DEFAULT true
    );
