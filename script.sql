...
ALTER TABLE "purchase_item" ADD FOREIGN KEY ("supplier_fk") REFERENCES "supplier" ("id");

ALTER TABLE "purchase_item" ADD FOREIGN KEY ("product_fk") REFERENCES "product" ("id");
